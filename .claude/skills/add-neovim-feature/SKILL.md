...
### Documentation
- docs/modules/ROOT/pages/guides/<name>.adoc — feature guide
- docs/modules/ROOT/pages/cheatsheets/<name>.adoc — keybinding reference
- docs/modules/ROOT/pages/cheatsheets/index.adoc — updated plugin table + quick reference
- docs/modules/ROOT/nav.adoc — added guide + cheatsheet entries
