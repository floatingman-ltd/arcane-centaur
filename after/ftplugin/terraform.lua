...
-- 2 spaces is what `terraform fmt` enforces; anything else is undone on the
-- next write.
o.tabstop = 2
o.shiftwidth = 2
o.expandtab = true
...
-- bind itself.
--
-- The console evaluates against real state, not a scratch environment. In an
-- uninitialised directory it starts but answers little -- run `terraform init`
-- first for anything referring to providers or resources.
