...
vim.keymap.set("n", "<localleader>a", function() require("kulala").run_all() end,          { buffer = true, desc = "REST: run all requests" })
vim.keymap.set("n", "<localleader>s", function() require("kulala").scratchpad() end,        { buffer = true, desc = "REST: open scratchpad" })
