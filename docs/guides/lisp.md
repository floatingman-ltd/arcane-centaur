...
No Common Lisp LSP is configured by default in this repository. See [readme.md](../../readme.md#lsp-support) for shared LSP keybindings that apply in buffers where an LSP client is attached.
