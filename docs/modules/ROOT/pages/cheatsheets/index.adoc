...
|.NET — C++#++ and F++#++ (Roslyn {plus} iron.nvim {plus} fsautocomplete) |xref:dotnet.adoc[dotnet]

|AI Tools (Copilot CLI {plus} OpenSpec {plus} Serena {plus} Avante) |xref:ai-tools.adoc[ai-tools]

|Code Intelligence (LSP {plus} Completion {plus} Formatting) |xref:code-intelligence.adoc[code-intelligence]

|Clipboard |xref:editing.adoc#system-clipboard[editing] —
xref:../guides/clipboard.adoc[full guide]

|Editing (Visual Mode {plus} Clipboard {plus} Comments {plus} Surround) |xref:editing.adoc[editing]

|Git (vim-fugitive {plus} gitsigns {plus} diffview) |xref:git.adoc[git]

|Haskell (haskell-tools) |xref:haskell.adoc[haskell]

|Janet (Conjure {plus} vim-sexp) |xref:janet.adoc[janet]

|Lisp / Clojure / Scheme / Fennel (Conjure {plus} vim-sexp) |xref:lisp.adoc[lisp]

|Markdown Preview {plus} PlantUML {plus} HTML {plus} MARP {plus} Confluence {plus} Jira |xref:markdown.adoc[markdown]

|Navigation (Splits {plus} Fuzzy Finder {plus} File Tree {plus} Unimpaired) |xref:navigation.adoc[navigation]

|REST Client (kulala.nvim) |xref:rest.adoc[rest]
|===
...
→ xref:navigation.adoc[Full reference]
...
→ xref:file-tree.adoc[Full reference]
...
→ xref:editing.adoc[Full reference]
...
→ xref:comments.adoc[Full reference]
...
→ xref:formatting.adoc[Full reference]
...
→ xref:copilot.adoc[Full reference] · xref:ai-tools.adoc[AI Tools guide]
...
→ xref:ai-tools.adoc[Full reference]
...
→ xref:completion.adoc[Full reference]
...
→ xref:haskell.adoc[Full reference] · xref:../guides/haskell.adoc[Guide]
...
→ xref:lisp.adoc[Full reference] · xref:../guides/lisp.adoc[Guide]
...
→ xref:markdown.adoc[Full reference] · xref:../guides/diagrams.adoc[Diagrams
...
→ xref:plantuml.adoc[Full reference]
...
→ xref:rest.adoc[Full reference] · xref:../guides/rest.adoc[Guide]
