...
|.NET — C++#++ and F++#++ (Roslyn {plus} iron.nvim {plus} fsautocomplete) |xref:cheatsheets/dotnet.adoc[dotnet]

|AI Tools (Copilot CLI {plus} OpenSpec {plus} Serena {plus} Avante) |xref:cheatsheets/ai-tools.adoc[ai-tools]

|Code Intelligence (LSP {plus} Completion {plus} Formatting) |xref:cheatsheets/code-intelligence.adoc[code-intelligence]

|Clipboard |xref:cheatsheets/editing.adoc#system-clipboard[editing] —
xref:guides/clipboard.adoc[full guide]

|Editing (Visual Mode {plus} Clipboard {plus} Comments {plus} Surround) |xref:cheatsheets/editing.adoc[editing]

|Git (vim-fugitive {plus} gitsigns {plus} diffview) |xref:cheatsheets/git.adoc[git]

|Haskell (haskell-tools) |xref:cheatsheets/haskell.adoc[haskell]

|Janet (Conjure {plus} vim-sexp) |xref:cheatsheets/janet.adoc[janet]

|Lisp / Clojure / Scheme / Fennel (Conjure {plus} vim-sexp) |xref:cheatsheets/lisp.adoc[lisp]

|Markdown Preview {plus} PlantUML {plus} HTML {plus} MARP {plus} Confluence {plus} Jira |xref:cheatsheets/markdown.adoc[markdown]

|Navigation (Splits {plus} Fuzzy Finder {plus} File Tree {plus} Unimpaired) |xref:cheatsheets/navigation.adoc[navigation]

|REST Client (kulala.nvim) |xref:cheatsheets/rest.adoc[rest]
|===
...
→ xref:cheatsheets/code-intelligence.adoc[Full reference]
...
→ xref:cheatsheets/ai-tools.adoc[Full reference] · xref:cheatsheets/ai-tools.adoc[AI Tools guide]
...
→ xref:cheatsheets/markdown.adoc[Full reference]
