...
vim.keymap.set(
  ...
  { noremap = true, silent = true, desc = "Window: decrease width" }
)
vim.keymap.set(
  "n",
  "<C-Right>",
  ":vertical resize +2<CR>",
  { noremap = true, silent = true, desc = "Window: increase width" }
)
...
vim.keymap.set(
  ...
  "<leader>p",
  '"_dP',
  { noremap = true, silent = true, desc = "Paste without overwriting clipboard" }
)
...
vim.keymap.set(
  ...
  "<C-f>",
  ":NvimTreeFindFile<CR>",
  { noremap = true, silent = true, desc = "File tree: find current file" }
)
...
vim.keymap.set(
  ...
  "<leader>L",
  ide_layout,
  { noremap = true, silent = true, desc = "IDE layout: tree + editor + terminal" }
)
...
end, { noremap = true, silent = true, desc = "Fold: open all" })
vim.keymap.set("n", "zM", function()
  require("ufo").closeAllFolds()
end, { noremap = true, silent = true, desc = "Fold: close all" })
