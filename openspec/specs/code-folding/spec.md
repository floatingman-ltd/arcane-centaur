...
Provides structured, on-demand code folding via `nvim-ufo` with annotated foldtext showing fold name and line count. Uses LSP fold ranges for C# (Roslyn `#region` support) and treesitter for all other languages.
