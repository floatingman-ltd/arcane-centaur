...
- [x] 5.2 Remove the stray root-owned `docker/markserv/docs/` tree left behind by the earlier relative-`MD_DIR` failure. It is empty, untracked and needs `sudo rm -rf`, so it is the user's to run.
